<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Charter.aspx.vb" Inherits="Charter" %>
                                    ...
                                    <div class="tabbable">
                                        <div class="tab-content">
                                            <div class="tab-pane fade in active" id="tab-1">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <h3 style="color: #ffffff">پایین ترین قیمت پروازهای چارتر ایران به ترکیه</h3>
                                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-plane input-icon"></i>
                                                                <label style="text-align: right; color: #FFFFFF;">مبعدا</label>
                                                                <asp:DropDownList class="form-control" ID="txtFlyFrom" runat="server">
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-plane input-icon"></i>
                                                                ...
                                                                <asp:DropDownList class="form-control" ID="txtFlyTo" runat="server">
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="col-md-3">
                                                                <asp:Button class="btn btn-default btn-primary" ID="btnContinue" runat="server" 
                                                                    Text="ادامه" Width="100%" CausesValidation="False" />
                                                            </div>
                                                        </div>
                                                </div>
                                            </div>
